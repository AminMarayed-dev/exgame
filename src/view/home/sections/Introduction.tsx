        ...
        <div className="hidden md:grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              >
                یه مینی‌اپ فوق‌العاده از تیم داریا که توش نقش مدیرعامل یه رمزارز
                رو بازی می‌کنی! هر وقت روباه شنی کوچولو روی صفحه موبایلت ظاهر
                شد، سریع روش بزنی تا سکه جمع کنی. بعد با سکه‌هات کارت‌های توسعه
                بخری و نرخ «درآمد ساعتی»ت رو بالاتر ببری. ترکیبی از هیجان،
                استراتژی و درآمد دیجیتال، حالا با پشتوانه داریا!
              </motion.p>
            </div>
          </motion.div>
